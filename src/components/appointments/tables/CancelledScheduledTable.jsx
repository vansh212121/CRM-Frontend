...
export function CancelledTable({ appointments, onDelete, isDeleting }) {
    ...
    return (
      ...
      >
        ...
        <p className="text-xs text-muted-foreground/80">
          Cancelled or rejected requests will appear here history
        </p>
      </motion.div>
    );
  }
            ...
            <TableBody>
              {appointments.map((apt, index) => (
                ...
                >
                  ...
                  {/* 3. Declined Time (Using updated_at/submissionDate) */}
                  <TableCell className="py-5">
                    <div className="space-y-1">
                      ...
                      <div className="pl-5">
                        <span className="text-xs text-muted-foreground/80 bg-secondary/20 px-2 py-1 rounded">
                          {apt.submissionDate
                            ? format(new Date(apt.submissionDate), "h:mm a")
                            : ""}
                        </span>
                      </div>
                    </div>
